...
// // leftMotorFollower = new
// TalonFX(Constants.ElevatorConstants.ELEVATORLEFTID);
// // rightMotorMaster = new
// TalonFX(Constants.ElevatorConstants.ELEVATORRIGHTID);
// // leftMotorFollower = new
// TalonFX(Constants.ElevatorConstants.ELEVATORLEFTID);
// //
...
// // return rightMotorMaster.getPosition().getValueAsDouble() *
// // Constants.ElevatorConstants.INCHPERROTATION
...
// // return (height - Constants.ElevatorConstants.ELEVATORBASEHEIGHT) /
// // Constants.ElevatorConstants.INCHPERROTATION;
// // }
...
// // // leftMotorFollower.setControl(voltageRequest.withOutput(amt));
// // // leftMotorFollower.setControl(new
// Follower(rightMotorMaster.getDeviceID(),
// // // true));
// // }
...
// // SmartDashboard.putNumber("Raw Encoder Readings",
// // rightMotorMaster.getPosition().getValueAsDouble());
