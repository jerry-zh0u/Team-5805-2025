...
public class CompbotElevatorElevatorConf extends ElevatorConf {
  ...
  public static final int motorCurrentLimitStatorPeakLimit = 30; // change back to 80 JERRY after testing
  public static final boolean motorCurrentLimitSupplyEnableLimit = true;
  public static final int motorCurrentLimitSupplyPeakLimit = 30; // change back to 80 JERRY after testing
  public static final int motorCurrentLimitSupplyContinuousLimit = 30; // change back to 80 JERRY after testing
  ...
  private static final double trapezoidalLimitsVelocity = 0.9; // Tune later with Teddy (until it's whipping)
  private static final double trapezoidalLimitsAcceleration = 2.7; // Tune later with Teddy (until it's whipping)
  ...
  public static final double positionalLimitsMax = 0.9; // Tune later with measured values
