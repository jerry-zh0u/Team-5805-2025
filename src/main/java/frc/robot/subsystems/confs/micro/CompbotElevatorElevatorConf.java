...
public class CompbotElevatorElevatorConf extends ElevatorConf {
        ...
        public static final int[][] gearRatio = { { 11, 50 } }; // Note to Teddy that this is bad/dangerous for
                                                                // gears
        ...
        // v_min = 0.52 v_max = .16
        public static final FeedforwardConstants feedForward = new FeedforwardConstants(0.18, 0.34, 3.957857,
                        0.0);

        // public static final FeedforwardConstants feedForward = new
        // FeedforwardConstants(0.11, 0.35, 4.5924003749, 0.0);

        /* -------- Positional -------- */
        public static final PIDSGVAConstants slot0 = new PIDSGVAConstants(3, 0.0, 0.02, 0.0, 0.0, 0.0, 0.0);
        /* -------- Velocity -------- */
        ...
        private static final double trapezoidalLimitsVelocity = 1.5; // Tune later with Teddy (until it's
                                                                     // whipping)
        private static final double trapezoidalLimitsAcceleration = 2.5; // Tune later with Teddy (until it's
                                                                         // whipping)
